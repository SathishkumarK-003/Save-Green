...
import 'package:savegreen/firebase_auth_methods.dart';

import 'Businessman.dart';
import 'businessforpass.dart';
                                        ...
                                        text: TextSpan(
                                          ...
                                          recognizer: TapGestureRecognizer()
                                            ..onTap = () {
                                              ...
                                              Navigator.push(
                                                  context, MaterialPageRoute(builder: (context) => bforpass()));
                                            },
                                        ),
                                      ),
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          recognizer: TapGestureRecognizer()
                                            ..onTap = () {
                                              HapticFeedback.lightImpact();
                                              Navigator.push(
                                                  context, MaterialPageRoute(builder: (context) => bsignup()));
                                            },
                                        ),
                                      ),
                                    ],
