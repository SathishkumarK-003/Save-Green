...
class fforpass extends StatefulWidget {
  @override
  _fforpassState createState() => _fforpassState();
}

class _fforpassState extends State<fforpass> {
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      Navigator.push(
                                          context, MaterialPageRoute(builder: (context) => flogin()));
                                    },
                                    child: Container(
